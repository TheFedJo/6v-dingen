...
echo.
echo.
echo Als je nu verder gaat, gaat de batch file naar de Steam site en zal de Installer downloaden. 
echo De rest moet je dan zelf doen. Druk op de spatiebalk of gebruik de enter-toets om door te gaan.
pause >nul
echo H:\
echo.
timeout /t 1 /nobreak >NUL
echo H:\cd ..\..\..\Program Files (x86)\google\chrome\application
echo.
timeout /t 1 /nobreak >NUL
echo H:\start https://store.steampowered.com/about/download/
echo.
timeout /t 2 /nobreak >NUL
echo De download is begonnen
timeout /t 1 /nobreak >NUL
echo .
timeout /t 1 /nobreak >NUL
echo .
...
timeout /t 1 /nobreak >NUL
echo .
echo %random%Oringinal%random%Steam%random%Installer>"H:\desktop\SteamInstallerVersion1034a.msi"
echo De download is gelukt. Druk op een toets om af te sluiten, dit kan even duren.
pause >nul
timeout /t 1 /nobreak >NUL
echo De browser wordt afgesloten...
